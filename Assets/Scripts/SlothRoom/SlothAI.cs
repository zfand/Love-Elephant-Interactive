...
namespace LoveElephant
{
  public class SlothAI : MonoBehaviour
  {
    ...
    void Start()
    {
	  ...
	  controller = GetComponent<AIRuntimeController>();	
      faceLeft = true;
    ...
    */
    ...
    void Update()
    {
		if (controller.CurrentState == controller.GetStateByName("IdleState")){
          facePlayer ();
		} else if(controller.CurrentState == controller.GetStateByName("Charge")){
