...
public class TwoAreaGraphEditorWindow : TwoAreaEditorWindow {
	...
	{
		base.OnRightGUI ();
		DrawGrid (rightRect, rightScroll);
		HandleRightAreaEvents ();
	}

	protected override void OnLeftGUI ()
	{
		base.OnLeftGUI ();
		HandleLeftAreaEvents ();
	}

	protected virtual void HandleLeftAreaEvents(){

	}

	protected virtual void HandleRightAreaEvents(){
