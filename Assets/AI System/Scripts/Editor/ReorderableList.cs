...
public class ReorderableList
{
    ...
    {
		name = System.Text.RegularExpressions.Regex.Replace(serializedProperty.name, "[A-Z]", " $0"); 
    ...
    void InitdefaultCallback()
    {
        ...
        onRemoveDelegateCallback = (serializedObject) => { };
    ...
    void SetDelegate(string typePath, string delegateName, string callbackName)
    {
        ...
        Delegate @delegate = Delegate.CreateDelegate(deleg, this, GetType().GetMethod(callbackName, BindingFlags.NonPublic | BindingFlags.Instance));
    ...
    public delegate void RemoveCallbackDelegate(object obj);
